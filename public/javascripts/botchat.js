                    ...
                    case "application/vnd.microsoft.card.hero":
                        ...
                        if (e.content.title == "화이트 크림" || e.content.title == "이온 실버" || e.content.title == "루나 그레이" || e.content.title == "판테라 그레이" || e.content.title == "미드나잇 블랙" || e.content.title == "발렌타인 레드" || e.content.title == "그랑 블루" || e.content.title == "쉐이드 브론즈" || e.content.title == "카키 메탈") {
                            ...
                            if (e.content.title.indexOf("_tts") > -1) {
                                ...
                                var ttsStr = e.content.text.replace("(주)", " ").replace("(주)", " ").replace(/\//gi, " ").replace("(1111)", " ").replace("(2222)", " ").replace("(3333)", " ");
        ...
        var r = n(13),
            ...
            c = function(t) {
                ...
                return r.__extends(e, t), e.prototype.componentWillUpdate = function() {
                    ...
                    this.scrollContent.style.marginTop = t + "px", this.scrollToBottom && (this.scrollMe.scrollTop = this.scrollMe.scrollHeight - this.scrollMe.offsetHeight)
